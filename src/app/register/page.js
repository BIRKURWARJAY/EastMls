        ...
        <CardContent sx={{ border: "none", }}>
          <FormControl sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
            <Stack>
              ...
              <TextField variant="standard" placeholder="Enter Your Name" sx={{ bgcolor: "white", outline: "none", borderRadius: "10px", padding: "10px" }} InputProps={{
            ...
            <Stack>
              ...
              <TextField variant="standard" placeholder="Enter Your Email" sx={{ bgcolor: "white", outline: "none", borderRadius: "10px", padding: "10px" }} InputProps={{
                disableUnderline: true
              }}/>
            </Stack>
            ...
            {toggleButton === "agent" && (
              <Stack>
                ...
                <TextField variant="standard" placeholder="Enter Your License Number" sx={{ bgcolor: "white", outline: "none", borderRadius: "10px", padding: "10px" }} InputProps={{
                disableUnderline: true
              }} />
              </Stack>
            )}
            ...
            <Stack>
              ...
              <TextField variant="standard" type="password" placeholder="Enter Your Password" sx={{ bgcolor: "white", padding: "10px", borderRadius: "10px" }} InputProps={{
